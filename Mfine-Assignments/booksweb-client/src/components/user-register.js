...
const UserRegistration = (props) => {
    ...
    const [errors, setErrors] = useState(null); //using instead of classes.cuz we needed class while using state
    ...
    const handleRegister = async(e) => {
        e.preventDefault();
        let newUser={...user};
        delete newUser.confirmPassword;  //cuz we don't want to store confrm pass into db
